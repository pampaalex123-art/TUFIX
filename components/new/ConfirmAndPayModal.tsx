    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="confirm modal title">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative">
        <div className="text-center">
            ...
            <h2 id="confirm-modal-title" className="text-2xl font-bold text-black">{t('confirm release title')}</h2>
            <p className="text-black mt-2">
                {t('confirm release body', { amount: formatCurrency(invoice.total, invoice.currency) })}
            </p>
        </div>
